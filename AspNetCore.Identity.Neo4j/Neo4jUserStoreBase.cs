...
namespace AspNetCore.Identity.Neo4j
{
    ...
    public abstract class Neo4jUserStoreBase<TUser, TUserClaim, TUserLogin, TUserToken> :
        ...
        where TUserToken : Neo4jIdentityUserToken, new()
    {
        ...
        /// <summary>
        /// Called to create a new instance of a <see cref="Neo4jIdentityUserClaim"/>.
        /// </summary>
        ...
        /// <summary>
        /// Called to create a new instance of a <see cref="Neo4jIdentityUserLogin"/>.
        /// </summary>
        /// <param name="user">The associated user.</param>
        ...
        /// <summary>
        /// Called to create a new instance of a <see cref="Neo4jIdentityUserToken"/>.
        /// </summary>
        /// <param name="user">The associated user.</param>
        ...
        /// </returns>
        public abstract Task<TUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public abstract Task SetTokenAsync(TUser user, string loginProvider, string name, string value, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public abstract Task RemoveTokenAsync(TUser user, string loginProvider, string name, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public abstract Task<string> GetTokenAsync(TUser user, string loginProvider, string name, CancellationToken cancellationToken = default(CancellationToken));


        private const string InternalLoginProvider = "[Neo4jUserStore]";
    ...
    public abstract class Neo4jUserStoreBase<TUser, TRole, TUserClaim, TUserLogin, TUserToken, TRoleClaim> :
        Neo4jUserStoreBase<TUser, TUserClaim, TUserLogin, TUserToken>,
